...
ActiveRecord::Schema.define(:version => 20140520005130) do
  ...
  create_table "refinery_leg_finders", :force => true do |t|
    t.string   "zip"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end

  add_index "refinery_leg_finders", ["id"], :name => "index_refinery_leg_finders_on_id"

  create_table "refinery_legislator_lookups", :force => true do |t|
    t.string   "zipcode"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
    t.string   "address"
  ...
  create_table "refinery_salsas", :force => true do |t|
    t.string   "title"
    t.string   "published"
    t.string   "sent"
    t.string   "blast_key"
